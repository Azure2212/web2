...
<head>
  ...
  <link rel="StyleSheet" href='../css/vanchuyen1.css'>
...
<body>
  ...
  <!-- mainvanchuyen -->
  <div class="a10"><a class="a15" href="../htmlnew/nhap.php">Trang chủ </a> > <a class="a15" href="../htmlnew/vanchuyen.php">Vận Chuyển </a></div>
  <h2 class="vc1">CHÍNH SÁCH Vận Chuyển</h2>

  <li class="vc2"> <b>QUY ĐỊNH Vận Chuyển VÀ TÍNH PHÍ</b></li>

  <li class="vc2"> <b> Nhằm đáp ứng nhu cầu của khách hàng mua hàng tại cửa hàng Sinh Viên Technology, chúng tôi có có các chính sách về giao hàng và tính phí ship như sau:</b></li>
  <br>

  <li class="vc2"> <b>1. Phương thức thanh toán</b></li>
  <br>

  <li class="vc2"> Khách hàng chuyển khoản <b>100%</b> trước khi giao hàng hoặc thanh toán<b> TỐI THIỂU 50%</b> trước khi giao hàng, phần còn lại sẽ được thanh toán bằng<b> TIỀN MẶT ngay khi nhận hàng.</b></li>

  <li class="vc2"> a. Chuyển khoản:</li>

  <li class="vc2"> Thông tin chuyển khoản:</li>

  <li class="vc2"> Ngân hàng Sacombank</li>

  <li class="vc2">Tên tài khoản: Công ty CP TM DV SX VSM</li>

  <li class="vc2"> Số tài khoản:0602 5383 1009 - Sacombank - CN Hồ Chí Minh</li>

  <li class="vc2"> Nội dung chuyển khoản: HỌ TÊN _ SỐ ĐT ĐẶT HÀNG _ MÃ SẢN PHẨM_ONLINE </li>

  <li class="vc2">b. COD : Thanh toán bằng tiền mặt khi nhận hàng tại nhà hoặc tại cửa hàng.</li>
  <br>

  <li class="vc2"><b>2. Phí giao hàng</b></li>
  <br>
  <li class="vc2"><b>- MIỄN PHÍ </b>đơn hàng từ<b> 2 triệu đồng</b> trở lên tại khu vực<b> nội thành Hà Nội và TP.HCM.</b></li>

  <li class="vc2">- Đơn hàng dưới 2 triệu hoặc giao tại các khu vực khác, nhân viên tư vấn sẽ thông báo phí giao hàng.</li>

  <li class="vc2"><b>3. Quy định về thời gian giao hàng</b></li>

  <li class="vc2">- Trong nội thành:</li>

  <li class="vc3"> Trước 12h trưa: giao hàng buổi chiều/ tối cùng ngày (ngoại trừ hàng IPHONE 13 sẽ thỏa thuận).
    Sau 12h trưa: giao hàng sáng hôm sau hoặc trong chiều/ tối cùng ngày (nếu có thể).</li>
  <li class="vc3"> Ngoại thành và các tỉnh: Nhân viên tư vấn sẽ thông báo chính xác thời gian giao hàng đến khách hàng.</li>

  <li class="vc2">Rất mong nhận được sự hợp tác của Quí khách hàng để chúng tôi hoàn thiện hơn trong quá trình phục vụ khách hàng tốt nhất.
  </li>
  <li class="vc2">Trân trọng!</li>
  <br>
  <br>
  <br>
  <br>

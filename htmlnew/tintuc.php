...
<body>
    ...
    <div class="tintuc" style="width: 70%; float: left;height:1100px;">
        <ul>
            <li><a href=""><img class="im2" src="../admhtml/images/docsaohay.gif" alt="">
            ...
            <br>
            <li> <a href=""><img class="im1" src="../admhtml/images/laptop1.jpg" alt="">
            ...
            <br>
            <li> <a href=""><img class="im1" src="../admhtml/images/laptop2.jpg" alt="">
            ...
            <br>
            <li> <a href=""><img class="im1" src="../admhtml/images/laptop3.jpg" alt="">
            ...
            <li> <a href=""><img class="im1" src="../admhtml/images/laptop4.jpg" alt="">
                    <h4 class="c2">Mừng năm mới loạt thiết bị đeo tay thông minh giá yêu thương chỉ dưới 1 triệu đồng, không sắm là tiếc lắm đó.</h4>
    ...
    <div class="hot" style="float:left;width:30%;height:1000px;">
        <a href=""><img class="im3" src="../admhtml/images/docsaohay.gif" alt="">
        ...
        <a href=""><img class="im4" src="../admhtml/images/hot2.jpg" alt="">

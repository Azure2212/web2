...
<head>
  ...
  <link rel="StyleSheet" href='../css/daily1.css'>
...
<body>
      ...
      <nav>
        <ul>
          ...
          <li> <input type="text" class="a6" placeholder=" <?php if (isset($_GET["nvn"])) {
            ...
            <input type="submit" name="find" value="" class="b21" /><i class="fas fa-search" style=" margin-top: 20px; margin-left: -15px; color: black; position: absolute; font-size: 10px;">
            </i>
          </li>
  ...
  <!-- maindaily -->
  <div class="a16">
    <div class="a17">Rất Tiếc Hiện chưa có thông tin về đại lý Sinh Viên Technology!

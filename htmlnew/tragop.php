...
<body>
  ...
  <!-- maintragop -->
  <div class="a10"><a class="a15" href="../htmlnew/nhap.php">Trang chủ </a> > <a class="a15" href="../htmlnew/tragop.php">Trả Góp </a></div>
  </div>
  ...
  <p class="tragop4"> <b class="tragop4-1"> Để hiểu hơn về lợi ích của phương thức thanh toán này, mời Quý khách tham khảo ví dụ dưới đây:</b>
  <h4 class="tragop4-3">Trả góp Laptop Kawai ND - 21 giá 83.900.000 VNĐ</h4>
  ...
  <p class="tragop4"> <b class="tragop4-1"> CÁC NGÂN HÀNG LIÊN KẾT TRẢ GÓP:</b>
  <h4 class="tragop4-3">Chương trình trả góp 0% lãi suất được liên kết với 22 ngân hàng giúp việc mua hàng dễ dàng.</h4>
  </p>
